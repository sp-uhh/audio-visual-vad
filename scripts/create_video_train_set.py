...
def main():
    ...
    with h5.File(output_dataset_file, 'a', rdcc_nbytes=rdcc_nbytes, rdcc_nslots=rdcc_nslots) as f:    
        ...
        for dataset_type in dataset_types:
            ...
            # Create file list
            file_paths = speech_list(input_video_dir=input_video_dir,
            ...
            for i, file_path in tqdm(enumerate(file_paths)):
                ...
                speech, fs_speech = sf.read(input_video_dir + file_path, samplerate=None)
                ...
                if dataset_size == 'subset':
                    ...
                    output_path = output_video_dir + file_path
